...
export const Register = () => {
    ...
    return(
        <div className="contenedor mt-5">
            ...
            <Form.Group className="mb-3 mt-3 w-25 m-auto" controlId="exampleForm.ControlInput1" >
                <Form.Label>Password</Form.Label>
                <Form.Control type="password" placeholder="Password" onChange={handleChange} name="password"/>
            </Form.Group>
            <Form.Group className="mb-3 mt-3 w-25 m-auto" controlId="exampleForm.ControlInput2">
                <Form.Label>Confirm Password</Form.Label>
                <Form.Control type="password" placeholder="Password" onChange={handleChange} name="confirmPassword" />
            </Form.Group>
            <Form.Group className="mb-3 mt-3 w-25 m-auto" controlId="exampleForm.ControlInput3" >
                <Form.Label>First Name</Form.Label>
                <Form.Control type="text" placeholder="First Name" name="firstName" onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3 mt-3 w-25 m-auto" controlId="exampleForm.ControlInput4">
